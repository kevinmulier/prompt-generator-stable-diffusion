export const clothing_outfits = ["Armor", "Heavy Armor", "Kimono", "Suit", "Trench Coat", "Uniform"];

export const clothing_headwear = [
  "Astronaut Helmet",
  "Beret",
  "Crown",
  "Diving Helmet",
...
export const clothing_tops = ["Breastplate", "Cardigan", "Cloak", "Jacket", "Leather Jacket", "Shirt", "Sweater", "Vest"];

export const clothing_bottoms = ["Jeans", "Kilt", "Pants", "Skirt"];

export const clothing_footwear = ["Boots", "High Heels", "Sandal", "Shoes", "Sneakers"];

export const clothing_accessories = [
  "Backpack",
  "Bag",
  "Belt",
  "Brooch",
